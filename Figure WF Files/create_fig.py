...
def data_cleaning(clean):
    ...
    ax1 = plt.subplot(131)
    ax1.hist(fig_df['Pulse'], np.linspace(30, 150, 120), alpha=0.5, label='Charted VS')
    ax1.hist(fig_df['hr'], np.linspace(30, 150, 120), alpha=0.5, label='ECG',color = "red")
    ...
    ax2.hist(fig_df['edrk'], np.linspace(10, 40, 30), alpha=0.5, label='ECG VS',color = "red")
